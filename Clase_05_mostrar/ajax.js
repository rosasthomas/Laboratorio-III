function mostrar() {
    ...
    http.onreadystatechange = function () {
        if (http.readyState == 4 && http.status == 200) {
            var lis_autos = JSON.parse(http.responseText);
            var tabla = "<table border=2> <tr><td>Id</td><td>Nombre</td><td>Apellido</td><td>Perfil</td><td>Estado</td><td>Acciones</td></tr>";
